!(function (t) {
  ...
  function (t, i, e) {
    ...
    (r.prototype.getModelMatrix = function () {
      ...
      (r.prototype.loadTexture = function (t, i, e) {
        ...
        r.loadTexture(this.live2DModel, t, i, function () {
          g--, 0 == g && (o.isTexLoaded = !0), "function" == typeof e && e();
        });
      }),
      ...
      (o.loadJson = function (t) {
        ...
        for (var a = 0; a < _; a++) {
          ...
          var g = new n();
          (g.id = l), (g.type = u), (g.value = $), i.paramList.push(g);
        }
        return i;
      }),
      ...
      (s.prototype.updateParam = function (t) {
        ...
        switch (this.eyeState) {
          case d.STATE_CLOSING:
            (r = (e - this.stateStartTime) / this.closingMotionMsec),
              r >= 1 &&
                ((r = 1),
                (this.eyeState = d.STATE_CLOSED),
          ...
          case d.STATE_CLOSED:
            (r = (e - this.stateStartTime) / this.closedMotionMsec),
              r >= 1 &&
                ((this.eyeState = d.STATE_OPENING), (this.stateStartTime = e)),
              (i = 0);
            break;
          case d.STATE_OPENING:
            (r = (e - this.stateStartTime) / this.openingMotionMsec),
              r >= 1 &&
                ((r = 1),
                (this.eyeState = d.STATE_INTERVAL),
                (this.nextBlinkTime = this.calcNextBlink())),
              (i = r);
            break;
          case d.STATE_INTERVAL:
            this.nextBlinkTime < e &&
              ((this.eyeState = d.STATE_CLOSING), (this.stateStartTime = e)),
              (i = 1);
            break;
          case d.STATE_FIRST:
          default:
    ...
    var d = function () {};
    (d.STATE_FIRST = "STATE_FIRST"),
      (d.STATE_INTERVAL = "STATE_INTERVAL"),
      (d.STATE_CLOSING = "STATE_CLOSING"),
      (d.STATE_CLOSED = "STATE_CLOSED"),
      (d.STATE_OPENING = "STATE_OPENING"),
      ...
      (l.load = function (t) {
        for (
          ...
          var _ = o[s],
            ...
            p = parseFloat(h.mass);
          a.setup($, u, p);
          for (var f = _.src, g = f.length, d = 0; d < g; d++) {
            var y = f[d],
              m = y.id,
            ...
            var v = parseFloat(y.scale),
              S = parseFloat(y.weight);
            a.addSrcParam(T, m, v, S);
          }
          for (var L = _.targets, M = L.length, d = 0; d < M; d++) {
            var E = L[d],
              m = E.id,
            ...
            var v = parseFloat(E.scale),
              S = parseFloat(E.weight);
            a.addTargetParam(T, m, v, S);
          }
  ...
  function (t, i, e) {
    ...
    function n(t) {
      var i = F.width,
        e = F.height;
      C = new L.L2DTargetPoint();
      var r = e / i,
        o = I.default.VIEW_LOGICAL_LEFT,
        n = I.default.VIEW_LOGICAL_RIGHT,
        _ = -r,
        h = r;
      if (
        ((N = new L.L2DViewMatrix()),
        N.setScreenRect(o, n, _, h),
        N.setMaxScreenRect(
          I.default.VIEW_LOGICAL_MAX_LEFT,
          I.default.VIEW_LOGICAL_MAX_RIGHT,
          I.default.VIEW_LOGICAL_MAX_BOTTOM,
          I.default.VIEW_LOGICAL_MAX_TOP
        ),
        N.setMaxScale(I.default.VIEW_MAX_SCALE),
        N.setMinScale(I.default.VIEW_MIN_SCALE),
        (B = new L.L2DMatrix44()),
        B.multScale(1, i / e),
        (U = new L.L2DMatrix44()),
        U.multTranslate(-i / 2, -e / 2),
        U.multScale(2 / i, -2 / i),
        (b = v()),
        (0, O.setContext)(b),
        !b)
      ...
      window.Live2D.setGL(b), b.clearColor(0, 0, 0, 0), a(t), s();
    }
    function s() {
      R ||
        ((R = !0),
    ...
    function _() {
      w.default.reset(),
        w.default.loadIdentity(),
        C.update(),
        D.setDrag(C.getX(), C.getY()),
        b.clear(b.COLOR_BUFFER_BIT),
        w.default.multMatrix(B.getArray()),
        w.default.multMatrix(N.getArray()),
        w.default.push();
      for (var t = 0; t < D.numModels(); t++) {
        var i = D.getModel(t);
        if (null == i) return;
        i.initialized && !i.updating && (i.update(), i.draw(b));
      }
      w.default.pop();
    }
    function a(t) {
      (D.reloadFlg = !0), D.count++, D.changeModel(b, t);
    }
    function h(t, i) {
    ...
    function u(t) {
      ...
      var i = F.getBoundingClientRect(),
        e = T(t.clientX - i.left),
        r = P(t.clientY - i.top),
        o = $(
          { x: i.left + i.width / 2, y: i.top + i.height * V },
          { x: t.clientX, y: t.clientY },
          i
        ),
        n = y(o.x - i.left),
        s = m(o.y - i.top);
      I.default.DEBUG_MOUSE_LOG &&
        console.log(
    ...
    function f(t) {
      ...
      I.default.DEBUG_MOUSE_LOG &&
        ...
        G && ((Y = e), (k = r), C.setPoint(n, s));
    }
    function c() {
      G && (G = !1), C.setPoint(0, 0);
    }
    function g(t) {
      if ("mousewheel" == t.type);
      else if ("mousedown" == t.type) p(t);
      else if ("mousemove" == t.type) u(t);
      else if ("mouseup" == t.type) {
        if ("button" in t && 0 != t.button) return;
      } else "mouseleave" == t.type && c();
    }
    function d(t) {
      var i = t.touches[0];
      "touchstart" == t.type
        ? 1 == t.touches.length && p(i)
        : "touchmove" == t.type
        ? f(i)
        : "touchend" == t.type && c();
    }
    function y(t) {
      var i = U.transformX(t);
      return N.invertTransformX(i);
    }
    function m(t) {
      var i = U.transformY(t);
      return N.invertTransformY(i);
    }
    function T(t) {
      return U.transformX(t);
    }
    function P(t) {
      return U.transformY(t);
    }
    function v() {
      for (
        ...
        try {
          var e = F.getContext(t[i], { premultipliedAlpha: !0 });
          if (e) return e;
        } catch (t) {}
      return null;
    }
    function S(t, i, e, r, s, _) {
      (V = void 0 === e ? 0.5 : e),
        (X = void 0 === r ? 1 : r),
        (z = void 0 === s ? 0.7 : s),
        (H = void 0 === _ ? 1 : _),
      ...
      !(function () {
            ...
            if (e > 0) {
              ...
              for (var r = 0; r < this.clipContextList.length; r++) {
                ...
                for (
                  ...
                  var g = o.clippingMaskDrawIndexList[c],
                    d = t.getDrawData(g),
                    y = t._$C2(g);
                  i.setClipBufPre_clipContextForMask(o), d.draw(i, t, y);
                }
              }
            ...
            for (
              ...
              if (p._$yo()) {
                for (
                  ...
                  (g[y] = f[m]), (d[y] = f[m + 1]), y++;
                var T = Math.min.apply(null, g),
                  P = Math.min.apply(null, d),
        ...
        (It._$ni = function (t, i, e, r, o, n, s, _, a) {
          ...
          (S._$br = function (t, i, e, r) {
            ...
            if (3 == o) {
              ...
              return (
                (1 - P) *
                  ((1 - u) * (p + (f - p) * h) + u * (c + (g - c) * h)) +
                P * ((1 - u) * (d + (y - d) * h) + u * (m + (T - m) * h))
              );
            }
            if (4 == o) {
              var v = r[n[0]],
              ...
              return (
                (1 - B) *
                  ((1 - P) *
                    ((1 - u) * (v + (S - v) * h) + u * (L + (M - L) * h)) +
                    P * ((1 - u) * (E + (A - E) * h) + u * (I + (x - I) * h))) +
                B *
                  ((1 - P) *
                    ((1 - u) * (w + (O - w) * h) + u * (D + (R - D) * h)) +
          ...
          (S._$Vr = function (t, i, e, r, o, n, s, _) {
            ...
            if (a <= 0) {
              ...
              for (
                var f = o[h[0]], g = o[h[1]], d = l[0], y = 1 - d, c = 0;
                c < $;
              ...
              for (
                ...
                (n[u] = S * f[c] + L * g[c] + M * m[c] + E * T[c]),
                  ++c,
                  (n[u + 1] = S * f[c] + L * g[c] + M * m[c] + E * T[c]),
                  ++c,
                  (u += _);
            else if (3 == a)
              for (
              ...
              for (
                ...
                for (var xt = It, wt = 1, Ot = 0; Ot < a; Ot++)
                  (wt *= xt % 2 == 0 ? 1 - l[Ot] : l[Ot]), (xt /= 2);
                At[It] = wt;
              }
          ...
          (F.prototype.transform = function (t, i, e) {
            ...
            switch (this._$hi) {
              ...
              case F.STATE_IDENTITY:
                return void ((t == i && h == l) || x._$jT(t, h, i, l, 2 * e));
            }
          }),
          ...
          (N.prototype.add = function (t) {
            if (this._$P.length <= this.size) {
              ...
              x._$jT(this._$P, 0, i, 0, this.size), (this._$P = i);
            }
        ...
        (Y._$V2 = -1),
          ...
          (Y.prototype.init = function () {
            ...
            for (var g = o.length, d = yt._$2o(); ; ) {
              for (var y = !1, s = 0; s < g; ++s) {
                var m = o[s];
                if (null != m) {
                  var T = m.getTargetBaseDataID();
                  (null == T || T == d || this.getBaseDataIndex(T) >= 0) &&
                    (this._$3S.push(m),
                    this._$db.push(n[s]),
                    (o[s] = null),
                    (y = !0));
          ...
          (Y.prototype.update = function () {
            ...
            for (var u = null, p = 0; p < r; ++p) {
              ...
              try {
                ...
                g == Y._$V2 ? (this._$Ws[d] = p) : (this._$Er[g] = p),
                  (this._$Vs[d] = p);
              } catch (t) {
            ...
            switch (this._$_L) {
              case STATE_CLOSING:
                (r = (e - this._$bb) / this._$Dr),
                  r >= 1 &&
                    ((r = 1), (this._$_L = xt.STATE_CLOSED), (this._$bb = e)),
                  (i = 1 - r);
                break;
              case STATE_CLOSED:
                (r = (e - this._$bb) / this._$Cb),
                  r >= 1 && ((this._$_L = xt.STATE_OPENING), (this._$bb = e)),
                  (i = 0);
                break;
              case STATE_OPENING:
                (r = (e - this._$bb) / this._$mr),
                  r >= 1 &&
                    ((r = 1),
                    (this._$_L = xt.STATE_INTERVAL),
                    (this._$12 = this._$T2())),
                  (i = r);
                break;
              case STATE_INTERVAL:
                this._$12 < e &&
                  ((this._$_L = xt.STATE_CLOSING), (this._$bb = e)),
                  (i = 1);
                break;
              case STATE_FIRST:
              default:
        ...
        var xt = function () {};
        (xt.STATE_FIRST = "STATE_FIRST"),
          (xt.STATE_INTERVAL = "STATE_INTERVAL"),
          (xt.STATE_CLOSING = "STATE_CLOSING"),
          (xt.STATE_CLOSED = "STATE_CLOSED"),
          (xt.STATE_OPENING = "STATE_OPENING"),
          (X.prototype = new E()),
          (X._$As = 32),
          (X._$Gr = !1),
          (X._$NT = null),
          ...
          (X.prototype._$nS = function (t) {
            var i = Math.max(2 * this._$sb.length, t + 1 + 10),
              e = new Int32Array(i);
            x._$jT(this._$sb, 0, e, 0, this._$sb.length), (this._$sb = e);
            var r = new Array();
            ...
            if (this._$GS._$Ur(t)) {
              ...
              if ((this._$GS._$zr(n, s, o), o <= 0)) {
                ...
                var c = this._$Y0[n[0]],
                  ...
                  u = s[1],
                  S = s[2],
                  p = c._$fL + (g._$fL - c._$fL) * h,
                  f = d._$fL + (y._$fL - d._$fL) * h,
                  L = m._$fL + (T._$fL - m._$fL) * h,
                  M = P._$fL + (v._$fL - P._$fL) * h;
                (e._$Yr._$fL =
                  (1 - S) * (p + (f - p) * u) + S * (L + (M - L) * u)),
                  (p = c._$gL + (g._$gL - c._$gL) * h),
                  (f = d._$gL + (y._$gL - d._$gL) * h),
                  (L = m._$gL + (T._$gL - m._$gL) * h),
                  (M = P._$gL + (v._$gL - P._$gL) * h),
                  (e._$Yr._$gL =
                    (1 - S) * (p + (f - p) * u) + S * (L + (M - L) * u)),
                  (p = c._$B0 + (g._$B0 - c._$B0) * h),
                  (f = d._$B0 + (y._$B0 - d._$B0) * h),
                  (L = m._$B0 + (T._$B0 - m._$B0) * h),
                  (M = P._$B0 + (v._$B0 - P._$B0) * h),
                  (e._$Yr._$B0 =
                    (1 - S) * (p + (f - p) * u) + S * (L + (M - L) * u)),
                  (p = c._$z0 + (g._$z0 - c._$z0) * h),
                  (f = d._$z0 + (y._$z0 - d._$z0) * h),
                  (L = m._$z0 + (T._$z0 - m._$z0) * h),
                  (M = P._$z0 + (v._$z0 - P._$z0) * h),
                  (e._$Yr._$z0 =
                    (1 - S) * (p + (f - p) * u) + S * (L + (M - L) * u)),
                  (p = c._$qT + (g._$qT - c._$qT) * h),
                  (f = d._$qT + (y._$qT - d._$qT) * h),
                ...
                var E = this._$Y0[n[0]],
                  ...
                  f = I._$fL + (x._$fL - I._$fL) * h,
                  L = w._$fL + (O._$fL - w._$fL) * h,
                ...
                (e._$Yr._$fL =
                  ...
                  (f = I._$gL + (x._$gL - I._$gL) * h),
                  (L = w._$gL + (O._$gL - w._$gL) * h),
                  ...
                  (f = I._$B0 + (x._$B0 - I._$B0) * h),
                  (L = w._$B0 + (O._$B0 - w._$B0) * h),
                  ...
                  (f = I._$z0 + (x._$z0 - I._$z0) * h),
                  (L = w._$z0 + (O._$z0 - w._$z0) * h),
                  ...
                  (f = I._$qT + (x._$qT - I._$qT) * h),
                  (L = w._$qT + (O._$qT - w._$qT) * h),
          ...
          (q._$er = function (t) {
            ...
            if (!i.exists()) throw new _$ls("_$t0 _$_ _$6 _$Ui :: " + i._$PL());
            for (
              var e = [
          ...
          (Z.transformPoints_sdk2 = function (i, e, r, o, n, s, _, a) {
            for (
              ...
              if (
                ...
                else (e[T] = p + S * c + L * d), (e[T + 1] = f + S * g + L * y);
              } else
                (l = P - (0 | P)),
                  ($ = v - (0 | v)),
                  (h = 2 * ((0 | P) + (0 | v) * (_ + 1))),
            ...
            try {
              ...
              for (
                ...
                It._$ni(F, C, O, D, R - O, b - D, -(b - D), R - O, y),
                  It._$ni(x, w, M, E, A - M, I - E, -(I - E), A - M, m);
                var H = (m[0] - y[0]) / y[1],
                  W = Math.min(O, R, F),
                  j = Math.max(O, R, F),
                  q = Math.min(D, b, C),
                ...
                if (
                  ...
                  if (
                    ...
                    rt.translate(-Q, -Z),
                      nt.clip(rt, d, n, Y, O, D, R, b, F, C, M, E, A, I, x, w),
                      rt.drawImage(t, 0, 0),
                      (it.gl_cacheImage[P] = {
                        cacheCanvas: et,
                        cacheContext: rt,
                  ...
                  at.IGNORE_CLIP ||
                    nt.clip(u, d, n, Y, O, D, R, b, F, C, M, E, A, I, x, w),
        ...
        (at._$yr = !1),
          ...
          (ct.prototype.startMotion = function (t, i) {
            ...
            if (null == t) return -1;
            (e = new gt()), (e._$w0 = t), this.motions.push(e);
            var n = e._$sr;
            return (
              this._$eb &&
                _._$Ji(
          ...
          (dt.prototype.setContext = function (t) {
            var i = this.m;
          ...
          (dt.prototype._$PS = function (t, i, e) {
          ...
          (dt.prototype.transform = function (t, i, e) {
            null == e && (e = new Array(0, 0));
            var r = this.m;
            return (
              (e[0] = r[0] * t + r[3] * i + r[6]),
          ...
          (dt.prototype.translate = function (t, i) {
            var e = this.m;
            (e[6] = e[0] * t + e[3] * i + e[6]),
              (e[7] = e[1] * t + e[4] * i + e[7]),
              (e[8] = e[2] * t + e[5] * i + e[8]);
          }),
          (dt.prototype.scale = function (t, i) {
            var e = this.m;
            (e[0] *= t),
              (e[1] *= t),
              (e[2] *= t),
          ...
          (dt.prototype.shear = function (t, i) {
            var e = this.m,
              r = e[0] + e[3] * i,
              o = e[1] + e[4] * i,
              n = e[2] + e[5] * i;
          ...
          (dt.prototype.concatenate = function (t) {
            var i = this.m,
              e = t.m,
              ...
              if (null != this.clipBufPre_clipContextMask)
                ...
                switch (s) {
                  case $t._$ms:
                    ...
                    break;
                  case $t._$ns:
                    (g = a.ONE), (d = a.ONE), (y = a.ZERO), (m = a.ONE);
                    break;
                  case $t._$_s:
                    (g = a.DST_COLOR),
                      (d = a.ONE_MINUS_SRC_ALPHA),
            ...
            for (var i = 0; i < r.modelSetting.getTextureNum(); i++) {
              ...
              r.loadTexture(i, o, function () {
                if (r.isTexLoaded) {
                  ...
                  if (
                    (null == r.eyeBlink && (r.eyeBlink = new n.L2DEyeBlink()),
